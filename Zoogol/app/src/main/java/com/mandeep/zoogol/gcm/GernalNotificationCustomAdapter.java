 ...
 */
public class GernalNotificationCustomAdapter extends ArrayAdapter<NotificationBean> {
    private final Context context;
    private ArrayList<NotificationBean> items;
    private boolean deleteIconVisible;

    public GernalNotificationCustomAdapter(Context context, ArrayList<NotificationBean> items) {
